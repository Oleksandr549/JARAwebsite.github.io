(() => {
  ...
  const y = {
    ...
    updateSlides: function () {
      ...
      if ((0 === g.length && (g = [0]), 0 !== i.spaceBetween)) {
        ...
        (r = parseInt(
          ...
          t.centeredSlides
            ? n < e.loopedSlides - i / 2 ||
              ...
              ? (e.loopFix(),
                (n = m(h(s, `${o}[data-swiper-slide-index="${r}"]`)[0])),
                a(() => {
                  e.slideTo(n);
                }))
              : e.slideTo(n)
      ...
      events: {
        attachEvents: function () {
          ...
          (e.onTouchStart = k.bind(e)),
            ...
            (e.onClick = G.bind(e)),
            (e.onLoad = D.bind(e)),
            V || (t.addEventListener("touchstart", N), (V = !0)),
            F(e, "on");
        },
      ...
      return (
        ...
        Object.assign(t, {
          ...
          rtlTranslate:
            ...
            ("rtl" === s.dir.toLowerCase() || "rtl" === f(s, "direction")),
    ...
    window.addEventListener("DOMContentLoaded", () => {
      ...
      for (
        var s = function (e) {
          ...
          i = document.getElementsByClassName("bubbly-button"),
          r = 0;
        r < i.length;
        r++
      )
        i[r].addEventListener("click", s, !1);
    }),
    (function (e) {
      let t = new Image();
      (t.onload = t.onerror =
